...
def render_manager_dashboard():
    ...
    with tab_an:
        ...
        with col_m1:
            analiza_client = st.selectbox("Selectează Client / Filială:", clients_mock)
        with col_m2:
            analiza_produs = st.selectbox("Selectează Produs pt. Analiză:", list(st.session_state.db.keys()), key="mgr_prod_an")
